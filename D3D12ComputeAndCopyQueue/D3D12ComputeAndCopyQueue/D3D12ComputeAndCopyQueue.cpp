...
#include "stdafx.h"
#include "D3D12ComputeAndCopyQueue.h"
#include <thread>


D3D12ComputeAndCopyQueue::D3D12ComputeAndCopyQueue(UINT width, UINT height, std::wstring name) :
...
void D3D12ComputeAndCopyQueue::OnInit()
{
    LoadPipeline();
    LoadAssets();
}
...
void D3D12ComputeAndCopyQueue::LoadPipeline()
{
...
void D3D12ComputeAndCopyQueue::LoadAssets()
{
    ...
    m_commandList->SetName(L"Graphics Command List");
...
// RootSignatureの生成
void D3D12ComputeAndCopyQueue::CreateRootSignatures()
{
    // 描画用Root Signature
    {
...
// PipelineStateの生成
void D3D12ComputeAndCopyQueue::CreatePipelineStates()
{
    // 描画用パイプラインステート
    {
...
// ConstantBufferの生成
void D3D12ComputeAndCopyQueue::CreateConstantBuffers()
{
    // コンスタントバッファ
    {
...
void D3D12ComputeAndCopyQueue::OnUpdate()
{
...
void D3D12ComputeAndCopyQueue::OnDestroy()
{
...
void D3D12ComputeAndCopyQueue::PopulateCommandList()
{
...
void D3D12ComputeAndCopyQueue::WaitForPreviousFrame()
{
...
void D3D12ComputeAndCopyQueue::WaitForCompute()
{
    // WAITING FOR THE FRAME TO COMPLETE BEFORE CONTINUING IS NOT BEST PRACTICE.
    // This is code implemented as such for simplicity. The D3D12HelloFrameBuffering
    // sample illustrates how to use fences for efficient resource usage and to
...
void D3D12ComputeAndCopyQueue::WaitForCopy()
{
    // WAITING FOR THE FRAME TO COMPLETE BEFORE CONTINUING IS NOT BEST PRACTICE.
    // This is code implemented as such for simplicity. The D3D12HelloFrameBuffering
    // sample illustrates how to use fences for efficient resource usage and to
